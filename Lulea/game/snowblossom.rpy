    ...
    class SnowFactory(object):
        ...
        def create(self, particles, st):
            ...
            if particles is None or len(particles) < self.max_particles:
                ...
                return [ SnowParticle(self.image[depth-1], random.uniform(-self.wind, self.wind)*depth_speed, self.speed*depth_speed, random.randint(self.xborder[0], self.xborder[1]), random.randint(self.yborder[0], self.yborder[1]),) ]
